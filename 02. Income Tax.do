...
foreach varoblig in income_financial property_value_base proptax_abat_dummy {
	cap gen `varoblig' = 0
}

/**********************************************************************************/
noi dis as result " 1. Tax on small independent businesses "
/**********************************************************************************/
...
capture confirm file "$presim/02_dummy_trimf.dta"
if _rc != 0 {
    dis as error "No se contaba con el archivo auxiliar 02_dummy_trimf, pero este código ya lo crea."
    preserve
